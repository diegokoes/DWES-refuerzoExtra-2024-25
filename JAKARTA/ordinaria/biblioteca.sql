DROP TABLE ejemplar_prestamo IF EXISTS CASCADE;
DROP TABLE ejemplar IF EXISTS CASCADE;
DROP TABLE prestamo IF EXISTS CASCADE;
DROP TABLE libro IF EXISTS CASCADE;
DROP TABLE socio IF EXISTS CASCADE;
